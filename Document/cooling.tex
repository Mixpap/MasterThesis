...
Στη συνέχεια θα επαναλάβουμε τη προσομοίωση της βαρυτικής κατάρρευσης μαζί με τη ψύξη του αερίου. Επειδή μας ενδιαφέρει να μελετήσουμε και τη μοριακή σύσταση (για το \ce{H2} προς το παρόν) θα χρησιμοποιήσουμε το module H2COOL το οποίο κρίνουμε ικανοποιητικό για τις χαμηλές τουλάχιστον θερμοκρασίες.
...
\end{figure}
	...
	Από το σχήμα (\ref{fig:h2coolgrhoprofile-be}) παρατηρούμε ότι η προσομοίωση συμφωνεί με το θεωρητικό μοντέλο της σφαίρας Bonnor - Ebert και κατ' επέκταση με παρατηρησιακά δεδομένα \todo{Citation needed}.  
