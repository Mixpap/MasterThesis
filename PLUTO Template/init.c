...
/* if_H2COOL */
  v[X_H2] = g_inputParam[x_H2_ism];
  v[X_HI] = g_inputParam[x_HI_ism];
  v[X_HII]= g_inputParam[x_HII_ism];
...
*/
  ...
  if (rs<g_inputParam[radius_cloud]) {
	/* if_H2COOL */
	v[X_H2] = g_inputParam[x_H2_cloud];
	v[X_HI] = g_inputParam[x_HI_cloud];
	v[X_HII]= g_inputParam[x_HII_cloud];
